...
<center>
    <h1>Display Data</h1>
    <button ><a href="registration_vaild.php">Insert</a></button>&nbsp;&nbsp;
    <button ><a href="vaildation/display_vaild.php">Vaildations</a></button> 
    <br><br> 
    <table border="1">
        <tr>
            <td>ID</td>
                ...
                echo "
                    <tr>
                        ...
                        <td>
                            ...
                            <button><a href='?id=".$row['id']."'>SOFT-DEL</a></button>
                        </td>
                    </tr>
                ";
